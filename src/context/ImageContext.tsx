...
const DEFAULT_IMAGES: KungnoiImageMap = {
  ...
  heroBanner: DEFAULT_SLIDES_PRESETS[1]?.url || '',
};

const STORAGE_KEY = 'kungnoi_y_custom_images_v5';
const CUSTOM_SLIDES_STORAGE_KEY = 'kungnoi_y_custom_slideshow_v5';
const HIDDEN_SLIDES_STORAGE_KEY = 'kungnoi_y_hidden_slides_v5';
...
const SLIDESHOW_STORAGE_KEY = 'kungnoi_y_slideshow_v7';
...
export const ImageProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const addCustomSlide = async (title: string, subtitle: string, url: string) => {
    ...
    const newSlide: SlideshowItem = {
      ...
      url: compressedUrl,
      isCustom: true,
      tag: `รูปที่ ${slideshowList.length + 1}`
    };
